...
const configHelperNetworksBase: ConfigHelperConfig = {
  networkId: null,
  network: 'unknown',
  metadataCacheUri: 'https://aquarius.v3.bigdataprotocolmarket.com', 
...
export const configHelperNetworks: ConfigHelperConfig[] = [
  ...
  },
  {
    ...
    providerUri: 'https://mainnet.provider.v3.bigdataprotocolmarket.com',
    subgraphUri: 'https://mainnet.subgraph.v3.bigdataprotocolmarket.com',
